 ...
 */
public class MathFilteredAction extends VetoAction {

    public static final String TYPE = MathFilteredAction.class.getName();
    ...
    public MathFilteredAction(final Operation operation, 
